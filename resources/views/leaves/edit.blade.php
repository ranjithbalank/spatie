                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" value="{{ $leave->user->name }}"
                                            disabled>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select name="leave_type" id="leave_type" class="form-select" required>
                                            ...
                                            <option value="casual" {{ $leave->leave_type == 'casual' ? 'selected' : '' }}>
                                                Casual
                                            </option>
                                            <option value="sick" {{ $leave->leave_type == 'sick' ? 'selected' : '' }}>Sick
                                            </option>
                                            <option value="earned" {{ $leave->leave_type == 'earned' ? 'selected' : '' }}>
                                                Earned
                                            </option>
                                            <option value="comp-off"
                                                {{ $leave->leave_type == 'comp-off' ? 'selected' : '' }}>
                                                Comp-Off</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select name="leave_duration" id="leave_duration" class="form-select" required>
                                            <option value="Full Day"
                                                {{ $leave->leave_duration == 'Full Day' ? 'selected' : '' }}>Full Day
                                            </option>
                                            <option value="Half Day"
                                                {{ $leave->leave_duration == 'Half Day' ? 'selected' : '' }}>Half Day
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" min="0" step="0.5" name="leave_days"
                                            id="leave_days" class="form-control" value="{{ $leave->leave_days }}" readonly>
                                    </div>
                                    <div class="col-md-6">
