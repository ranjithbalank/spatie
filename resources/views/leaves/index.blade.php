                                ...
                                @if (request()->get('view') === 'team')
                                    ...
                                    @hasanyrole('admin|hr')
                                        @if (request()->get('view') === 'team')
                                            <div class="d-flex justify-content-end mb-3">
                                                <div class="dropdown">
                                                    <button class="btn btn-outline-primary dropdown-toggle shadow-sm"
                                                ...
                                                <tr>
                                                    ...
                                                    @if (request()->get('view') === 'team')
                                                        <td class="text-primary">
                                                            {{ Str::ucfirst($leave->user->name ?? '-') }}
                                                        </td>
                                                    @endif
                                                    <td class="text-capitalize text-danger text-start">
                                                        {{ $leave->leave_type }}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <span
                                                                class="badge bg-secondary">{{ strtoupper('Unknown') }}</span>
                                                        @endif
                                                    </td>
                                                    <td>
