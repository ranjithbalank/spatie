                ...
                <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 rounded-lg">
                    <ul role="list" class="divide-y divide-gray-200">
                        ...
                        <li class="flex justify-between gap-x-6 bg-gray-50 py-3 px-4 font-semibold text-gray-900">
                            <span class="flex-1">Designation Name</span>
                            @canany(['edit designations', 'delete designations'])
                                <span class="w-24 text-right">Actions</span>
                            @endcanany(["edit designations" ,"delete designations"])
                        </li>
                            ...
                            <li class="flex justify-between gap-x-6 py-4 px-4 hover:bg-gray-50">
                                <div class="flex-1 flex items-center gap-x-4">
                                    <div
                                        ...
                                        {{ strtoupper(substr($designation->designation_name, 0, 1)) }}
                                    </div>
                                    <div>
                                        <p class="text-sm font-medium text-gray-900 truncate">
                                            {{ Str::ucfirst($designation->designation_name) }}
                                        </p>
