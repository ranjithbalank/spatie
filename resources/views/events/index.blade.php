            ...
            <div class="offcanvas-body">
                <form id="addEventForm">
                    ...
                    <div class="d-flex justify-content-end">
                        <button class="btn btn-secondary me-2" type="button" data-bs-dismiss="offcanvas">Cancel</button>
                ...
                <form method="POST" id="editEventForm">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <label>Start Date & Time</label>
                            <input type="datetime-local" name="start_date" id="edit_start_date" class="form-control mb-2" required>
                            <label>End Date & Time</label>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- HR/Admin Create Event button -->
                        <div class="mt-3 text-end" id="createEventBtnWrapper" style="display:none;">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    eventClick: function(info) {
                        ...
                        if (hasRole('admin') || hasRole('HR') || hasPermission('edit events')) {
                            ...
                            document.getElementById('edit_start_date').value = offset(new Date(event.start));
                            document.getElementById('edit_end_date').value = offset(event.end ? new Date(event.end) : new Date(event.start));
                ...
                function loadDailyEvents(dateStr) {
                    fetch(`/events/daily/${dateStr}`)
                        ...
                        .then(events => {
                            ...
                            if (hasRole('HR') || hasRole('admin') || hasPermission('create events')) {
                                document.getElementById('createEventBtnWrapper').style.display = 'block';
                                document.getElementById('createEventFromDailyBtn').onclick = function() {
                                    ...
                                    bootstrap.Modal.getInstance(document.getElementById('dailyEventModal')).hide();
                                    new bootstrap.Offcanvas(document.getElementById('addEventOffcanvas')).show();
                                };
                            } else {
                                document.getElementById('createEventBtnWrapper').style.display = 'none';
                            }
                ...
                document.getElementById('addEventForm').addEventListener('submit', function(e) {
                    ...
                    .then(event => {
                        ...
                        bootstrap.Offcanvas.getInstance(document.getElementById('addEventOffcanvas')).hide();
